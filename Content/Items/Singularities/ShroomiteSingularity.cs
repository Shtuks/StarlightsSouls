...
{
    public class ShroomiteSingularity : ModItem
    {
        ...
        {
            this.CreateRecipe(1).AddIngredient(1552, ModContent.GetInstance<ShtunConfig>().ItemsUsedInSingularity).AddTile<CrucibleCosmosSheet>().Register();
        }
    }
}

...
{
    public class PlatinumSingularity : ModItem
    {
        ...
        {
            this.CreateRecipe(1).AddIngredient(706, ModContent.GetInstance<ShtunConfig>().ItemsUsedInSingularity).AddTile<CrucibleCosmosSheet>().Register();
        }
    }
}

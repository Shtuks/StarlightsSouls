...
{
    public class PalladiumSingularity : ModItem
    {
        ...
        {
            this.CreateRecipe(1).AddIngredient(1184, ModContent.GetInstance<ShtunConfig>().ItemsUsedInSingularity).AddTile<CrucibleCosmosSheet>().Register();
        }
    }
}

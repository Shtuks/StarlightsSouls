...
{
    public class UelibloomSingularity : ModItem
    {
        ...
        {
            this.CreateRecipe(1).AddIngredient<UelibloomBar>(ModContent.GetInstance<ShtunConfig>().ItemsUsedInSingularity).AddTile<DraedonsForge>().Register();
        }
    }
}

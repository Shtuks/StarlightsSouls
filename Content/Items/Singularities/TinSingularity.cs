...
{
    public class TinSingularity : ModItem
    {
        ...
        {
            this.CreateRecipe(1).AddIngredient(703, ModContent.GetInstance<ShtunConfig>().ItemsUsedInSingularity).AddTile<CrucibleCosmosSheet>().Register();
        }
    }
}

...
{
	public class PerenialSingularity : ModItem
	{
    	...
    	{
    	  this.CreateRecipe(1).AddIngredient<PerennialBar>(ModContent.GetInstance<ShtunConfig>().ItemsUsedInSingularity).AddTile<DraedonsForge>().Register();
    	}
	}
}

...
namespace ssm.Content.Items.Singularities.Calamity
{
    ...
    public class BloodstoneSingularity : ModItem
    {
        ...
        {
            this.CreateRecipe(1).AddIngredient<Bloodstone>(ModContent.GetInstance<ShtunConfig>().ItemsUsedInSingularity).AddTile<DraedonsForge>().Register();
        }
    }
}

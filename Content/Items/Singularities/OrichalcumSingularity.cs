...
{
    public class OrichalcumSingularity : ModItem
    {
        ...
        {
            this.CreateRecipe(1).AddIngredient(1191, ModContent.GetInstance<ShtunConfig>().ItemsUsedInSingularity).AddTile<CrucibleCosmosSheet>().Register();
        }
    }
}

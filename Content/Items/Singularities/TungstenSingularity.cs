...
{
    public class TungstenSingularity : ModItem
    {
        ...
        {
            this.CreateRecipe(1).AddIngredient(705, ModContent.GetInstance<ShtunConfig>().ItemsUsedInSingularity).AddTile<CrucibleCosmosSheet>().Register();
        }
    }
}

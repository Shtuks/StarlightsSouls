...
{
    public class AeraliteSingularity : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.value = 1000000000; // Makes the item worth 1 gold.
            Item.rare = -13;
        }
        ...
        {
            this.CreateRecipe(1).AddIngredient<AerialiteBar>(i).AddTile<DraedonsForge>().Register();
        }
    }
}

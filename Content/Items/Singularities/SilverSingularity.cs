...
{
    public class SilverSingularity : ModItem
    {
        ...
        {
            this.CreateRecipe(1).AddIngredient(21, ModContent.GetInstance<ShtunConfig>().ItemsUsedInSingularity).AddTile<CrucibleCosmosSheet>().Register();
        }
    }
}

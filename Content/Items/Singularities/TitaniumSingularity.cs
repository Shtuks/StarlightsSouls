...
{
    public class TitaniumSingularity : ModItem
    {
        ...
        {
            this.CreateRecipe(1).AddIngredient(1198, ModContent.GetInstance<ShtunConfig>().ItemsUsedInSingularity).AddTile<CrucibleCosmosSheet>().Register();
        }
    }
}

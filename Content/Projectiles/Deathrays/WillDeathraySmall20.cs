...
{
    public class WillDeathraySmall20 : Deathrays.BaseDeathray
    {
        ...
        public WillDeathraySmall20() : base(60, drawDistance: 3600) { }
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            {
                Projectile.NewProjectile(Projectile.InheritSource(Projectile), Projectile.Center, Projectile.velocity, ModContent.ProjectileType<WillDeathrayBig20>(), Projectile.damage, 0f, Main.myPlayer, 0f, Projectile.ai[1]);
            }
        }

...
namespace ssm.Content.Projectiles.Shtuxibus.Cal
{
    public class FlareDust : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            Projectile.ExpandHitboxBy(48, 0);
            for (int d = 0; d < 2; d++)
            {
        ...
        public override bool? Colliding(Rectangle projHitbox, Rectangle targetHitbox) => ShtunUtils.CircularHitboxCollision(Projectile.Center, 16f * Projectile.scale, targetHitbox);
